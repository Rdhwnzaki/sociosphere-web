        ...
        <>
            ...
            <div className='flex justify-between mt-12'>
                ...
                <div className='flex-grow mx-8 w-3/6 max-h-[calc(100vh-100px)] overflow-y-auto scroll-smooth'>
                    ...
                    <div className="card bg-base-100 shadow-sm mt-10 rounded-md border mb-10">
                        <div className="card-body">
                                ...
                                <div className='bg-slate-200 rounded-lg mt-5 pb-5 w-11/12 border'>
                                    <div className='flex justify-between m-5'>
                                        <div className='flex items-center'>
                                            ...
                                            <div className='ms-5'>
                                                <p className='font-medium text-lg'>Ridhwan Zaki<div className="badge bg-cyan-600 ms-4 text-white p-3">Author</div></p>
